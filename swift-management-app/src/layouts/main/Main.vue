...
export default {
  ...
  data() {
    return {
      footerType        : baseConfig.footerType  || 'static',
      hideScrollToTop   : baseConfig.hideScrollToTop,
      isNavbarDark      : false,
      navbarColor       : baseConfig.navbarColor || '#fff',
      navbarType        : baseConfig.navbarType  || 'floating',
      navMenuItems      : navMenuItems,
      routerTransition  : baseConfig.routerTransition || 'none',
