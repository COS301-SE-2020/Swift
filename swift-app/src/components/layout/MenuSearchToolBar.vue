                ...
                <v-carousel-item gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.4)" :src="menu.image">
                    ...
                    <v-row no-gutters d-flex flex-row align="center" justify="center" class="fill-height">
                      <v-col cols="10" style="z-index: 11">
                        <v-autocomplete style="bottom: 50px;" rounded background-color="white" color="secondary" :items="items" :loading="isLoading" :search-input.sync="search" chips clearable hide-details hide-selected item-text="name" item-value="symbol" label="What would you like to order?" prepend-inner-icon="mdi-magnify" solo>
